...
# weights_plus_splines <- haven::read_dta("D:/Dropbox/My Documents/Research/AA/UNU-WIDER project/weights_plus_splines.dta") %>%
#   tibble %>%
#   select(
#     l_imputed_real, race, educ_10, educ_11, educ_12, educ_13, educ_15, 
...
#     year_2014, year_2015, year_2016, year_2017, phi
#   ) %>%
#   mutate(white = race == 4) %>%
